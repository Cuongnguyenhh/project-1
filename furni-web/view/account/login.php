                              ...
                              <div class="account-form">
                                    ...
                                    <div class="account-content">
                                          ...
                                          <div id="Login" class="tab-change active">
                                                      ...
                                                      <form id="login-form" method="POST"
                                                            ...
                                                            <div class="account-form-content">
                                                                  <div class="form-group">
                                                                        <input id="login-email-check"
                                                                              class="form-control" name="email_login"
                                                                              type="text" placeholder="Email">
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                                  <div class="form-group form-group--password">
                                                                        <input id="pswrd" type="password"
                                                                              name="pass_login" class="form-control"
                                                ...
                                                if ($kq == 0) { echo 'Đăng Nhập thất bại';
                                                 } else 
                                                { 
                                                ...
                                                <div class="account-register-form">
                                                      <form id="form-register" method="POST"
                                                            ...
                                                            <div class="account-form-content">
                                                                  ...
                                                                  <div class="form-group">
                                                                        <input id="register-email-check" type="text"
                                                                              class="form-control" name="email_user"
                                                                              placeholder="Email">
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                                  <div class="form-group form-group--password">
                                                                        <input id="pswrd-login" type="password"
                                                                              class="form-control" name="pass_user"
                                                                              placeholder="Mật khẩu">
                                                                        <span id="toggle-btn-login">Hiện</span>
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                                  <div class="form-group form-group--password">
                                                                        <input id="pswrd-register-check" type="password"
                                                                              class="form-control" name="pass_user"
                                                                              placeholder="Nhập lại mật khẩu">
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                                  <div class="form-button">
                                                                        <input type="submit" class="btn btn-form-login"
                                                                              name="register" value="TẠO TÀI KHOẢN">
                                                                  </div>
                                                                  <div class="forgot-password">
                                                                        <a href="#">Quên mật
                                                                              khẩu?</a>
                                                      ...
                                                      <?php if (isset($_POST['register'])) { $first_name = $_POST['first_name']; $last_name = $_POST['last_name']; $email_user = $_POST['email_user']; $pass_user = $_POST['pass_user']; addUser($user, $pass, $email, $phone, $fullname, $address, $rank, $created, $avartar); } ?>
                                                </div>
                                          </div>
                                    </div>
                              </div>
