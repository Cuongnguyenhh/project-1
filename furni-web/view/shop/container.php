                              ...
                              <aside class="vela-aside c-3">
                                    <div class="categories">
                                          ...
                                          <div class="categories-content">
                                                <ul class="categories-list">
                                                      ...
                                                      <li class="categories-item">
                                                            <a class="categories-item-link"
                                                                  href="shop.php?cate=<?= $c['ID'] ?> "><?= $c['prd_group_name'] ?></a>
                                                      </li>
                                                      <?php endforeach ?>
                                                </ul>
                                          </div>
                                    ...
                                    <div class="sidebar-color">
                                          ...
                                          <div class="color-content">
                                                <ul class="color-list">
                                                      <li class="color-item">
                                                            <a href="" class="color-item-link"
                                                                  style="background-color: black;">
                                                                  <img src="assets/img/color_default_icon.webp"
                                                                        alt="color-default">
                                                            </a>
                                                      </li>
                                                      <li class="color-item">
                                                ...
                                                <div class="product-sidebar">
                                                      <div class="product-sidebar-image">
                                                            <a href="#" class="product-sidebar-link">
                                                                  <img src="assets/img/product-1.webp"
                                                                        alt="product-sidebar">
                                                            </a>
                                                      </div>
                                          ...
                                          <div class="product-pagination">
                                                <nav class="pagination">
                                                      <ul class="pagination-list">
                                                            ...
                                                            <li class="pagination-item ">
                                                                  <a
                                                                        href="?page=<?= $page - 2 ?>"><?php echo $page - 2 ?></a>
                                                            </li>
                                                            <?php endif; ?>
                                                            ...
                                                            <li class="pagination-item active  "><a
                                                                        href="?page=<?php echo $page ?>"><?php echo $page ?></a>
                                                            </li>

                                                            <?php if ($next < ($total_page + 1)) : ?>
                                                            <li class="pagination-item ">
                                                                  <a
                                                                        href="shop.php?page=<?php echo $page + 1 ?>"><?php echo $page + 1 ?></a>
                                                            </li>
                                                            <?php endif; ?>
