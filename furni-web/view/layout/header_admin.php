            ...
            <div class="container">
                  <div class="header-main row-flex row-flex-margin align-items">
                        <div class="header-logo col c-2">
                              ...
                              <a href="index.php">
                                    <img src="https://cdn.shopify.com/s/files/1/1573/5553/files/logo_dark.svg?v=1601695205" alt="Logo Outstock">
                              </a>
                        </div>
                                                            ...
                                                            <div class="coll-list">
                                                                  <div class="coll-item">
                                                                        <a class="coll-image" href="#">
                                                                              <img src="https://cdn.shopify.com/s/files/1/1573/5553/collections/18_360x.jpg?v=1511442950" alt="Decor Art">
                                                                        </a>
                                                                        <h5 class="coll-title">
                                                                  ...
                                                                  <div class="coll-item">
                                                                        <a class="coll-image" href="#">
                                                                              <img src="https://cdn.shopify.com/s/files/1/1573/5553/collections/7_360x.jpg?v=1511442889" alt="Decor Art">
                                                                        </a>
                                                                        <h5 class="coll-title">
                                                                  ...
                                                                  <div class="coll-item">
                                                                        <a class="coll-image" href="#">
                                                                              <img src="https://cdn.shopify.com/s/files/1/1573/5553/collections/21_360x.jpg?v=1511442906" alt="Decor Art">
                                                                        </a>
                                                                        <h5 class="coll-title">
                                                                              <a href="#">Đồ nhà bếp</a>
                                                                        </h5>
                                                                  ...
                                                                  <div class="coll-item">
                                                                        <a class="coll-image" href="#">
                                                                              <img src="https://cdn.shopify.com/s/files/1/1573/5553/collections/12_360x.jpg?v=1511442995" alt="Decor Art">
                                                                        </a>
                                                                        <h5 class="coll-title">
                                                                  ...
                                                                  <div class="coll-item">
                                                                        <a class="coll-image" href="#">
                                                                              <img src="https://cdn.shopify.com/s/files/1/1573/5553/collections/Arc-Large-Cup_360x.jpg?v=1511443696" alt="Decor Art">
                                                                        </a>
                                                                        <h5 class="coll-title">
                                                                              <a href="#">Giảm giá</a>
                                                                        </h5>
                                    ...
                                    <div class="search-overlay">
                                          <div class="search-input">
                                                <div class="search-input__container">
                                                      <input type="search" name="" id="live_search" placeholder="Search...">
                                                </div>
                                                <ul id="result"></ul>
                                          </div>
                                    </div>
