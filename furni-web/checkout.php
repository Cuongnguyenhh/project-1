                                                ...
                                                <?php } else { ?>
                                                      <form action="payment.php" method="post" class="shipping__form">
                                                            <div class="main__info">
                                                                  ...
                                                                  <div class="info__content">
                                                                        <div class="info__field-set">
                                                                              <input type="email" name="email_contact" id="email-check" placeholder=" Email" aria-required="true">
                                                                              <span class="form-message"></span>
                                                                        </div>
                                                                        <div class="info__content-desc">
                                                                              <input id="checkbox__contact-info" type="checkbox">
                                                            ...
                                                            <div class="field__double">
                                                                  <div class="field field__first">
                                                                        <input id="first-check" type="text" name="fname_contact" placeholder="First name">
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                                  <div class="field field__last">
                                                                        <input id="last-check" type="text" name="lname_contact" placeholder="Last name">
                                                                        <span class="form-message"></span>
                                                                  </div>
                                                            </div>
                                                            <div class="field">
                                                                  <input id="address-check" type="text" name="add_contact" placeholder="Address">
                                                                  <span class="form-message"></span>
                                                            </div>
                                                            <div class="field">
                                                                  <input id="optional-check" type="text" name="phone_num" placeholder="Enter your number phone">
                                                                  <span class="form-message"></span>
                                                            </div>
                                                            <div class="field">
                                                                  <input id="city-check" type="text" name="city_contact" placeholder="City">
                                                                  <span class="form-message"></span>
                                                            </div>
                                                            <div class="field__save">
                                                                  <input type="checkbox" id="checkbox__save-remember">
