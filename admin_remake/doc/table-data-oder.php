            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                                ...
                                <a class="btn btn-add btn-sm" href="form-add-don-hang.php" title="Thêm"><i
                                        class="fas fa-plus"></i>
                                    Tạo mới đơn hàng</a>
                            </div>
                            <div class="col-sm-2">
                 ...
                 foreach($order as $order) : ?>
                   ...
                   ?>
                                    <td>
                                        <form action="./status_order.php?id=<?=$order['ID']?>" method="post">
                                            ...
                                            <button name="status_up"
                                                class="custom-btn btn-12"><span>Click!</span><span>Cập
                                                    nhật</span></button>
                                        </form>
                                    </td>
                                    <td>
                                        <button class="custom-btn btn-4"><span><a
                                                    href="./order_detail.php?id_order=<?=$order['ID']?>">Chi
                                                    tiết</a></span></button>
